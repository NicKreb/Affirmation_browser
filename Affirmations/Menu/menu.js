...
function menu() {
    for (var i = 0; i < localStorage.length; i++) {
        if (localStorage.getItem('options') === localStorage.getItem(localStorage.key(i))){
            return (shop.innerHTML = bothArr.map((x) => {
                ...
                .join(""),
                document.getElementById('icon_wrapper').innerHTML = '<i class="fa-solid fa-book title_icon"></i>',
                document.getElementById('item_1').innerHTML = "Menu");
        }
    }
}